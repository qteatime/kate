...
export function Cartridge(x: {readonly 'id': string,readonly 'version': Version,readonly 'release-date': Date,readonly 'metadata': (Metadata)[],readonly 'runtime': Runtime,readonly 'files': (File)[]}): Cartridge {
 return {
   '@name': 'Cartridge',
   '@tag': 0,
   '@version': 0,
...
export namespace Metadata {
 ...
 export function Accessibility(x: {readonly 'input-methods': (Input_method)[],readonly 'languages': (Language)[],readonly 'provisions': (Accessibility_provision)[],readonly 'average-completion': Duration,readonly 'average-session': Duration}): Metadata {
   return {
     '@name': 'Metadata',
     '@tag': 1,
     '@version': 0,
