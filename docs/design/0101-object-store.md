...
- **Lack of granular boundaries in cartridges**:<br>
...
Given a strong reference to a Branch partition, whose set of sub-partitions does not contain `pB`, we produce a new Branch partition that includes `pB`.
